...
function TopNav() {
  ...
  const {imageURL, setShowPopupInviteOrChat} = useStoreState()
      ...
      <div className='flex gap-7 items-center w-full justify-end px-2'>
       ...
       <div className="relative" ref={menuRef}>
         ...
         {showInviteChat && (
           ...
           <button onClick={() => setShowPopupInviteOrChat("Chat")} type='button' className='px-2 py-1.5 hover:opacity-80 flex items-center gap-2'>
             <IoChatboxEllipsesOutline size={18}/>
             Chat
           </button>

           
           <button type='button'  onClick={() => setShowPopupInviteOrChat("Invite")} className='px-2 py-1.5 hover:opacity-80 flex items-center gap-2'>
